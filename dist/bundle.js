...
;// CONCATENATED MODULE: ./src/components/FunctionList.js
...
/* harmony default export */ const FunctionList = (FunctionListData);
        ...
        column.items.forEach(item => {
          switch (item.func) {
            case "move_steps":
              newAnimations.push({
                type: "translateX",
                value: "".concat(item.input, "px")
              });
              break;
            case "turn_right":
              newAnimations.push({
                type: "rotate",
                value: "".concat(item.input, "deg")
              });
              break;
            case "turn_left":
              newAnimations.push({
  ...
  const executeAnimations = (animations, index) => {
    ...
    setTimeout(() => {
      ...
      if (animations[index].type === "say") {
        ...
        alert("I am thinking: ".concat(animations[index].message));
      }
    }, 500); // Adjust the delay as needed
  };
  return /*#__PURE__*/react.createElement("div", {
    className: "h-full overflow-y-auto p-2 cat-body"
    ...
    style: {
      ...
      transform: animations.slice(0, currentIndex + 1).reduce((acc, anim) => {
        switch (anim.type) {
          case "translateX":
            return "".concat(acc, " translateX(").concat(anim.value, ")");
          case "rotate":
            return "".concat(acc, " rotate(").concat(anim.value, ")");
          default:
            return acc;
        }
      }, "")
...
const App_onDragEnd = (result, columns, setColumns) => {
...
function App_App() {
  const [columns, setColumns] = (0,react.useState)(columnsFromBackend);
  const handleInputChange = (columnId, itemId, newValue) => {
    const updatedColumns = {
      ...columns
    };
    const column = updatedColumns[columnId];
    const updatedItems = column.items.map(item => item.id === itemId ? {
      ...item,
      input: newValue
    } : item);
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    onDragEnd: result => App_onDragEnd(result, columns, setColumns)
  }, Object.entries(columns).map((_ref, index) => {
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      key: columnId
    }, /*#__PURE__*/react.createElement("h2", null, column.name), /*#__PURE__*/react.createElement("div", {
      style: {
        margin: 8
      }
      ...
      key: columnId
    }, (provided, snapshot) => /*#__PURE__*/react.createElement("div", App_extends({}, provided.droppableProps, {
    ...
    }), column.items.map((item, index) => /*#__PURE__*/react.createElement(PublicDraggable, {
      key: item.id,
      draggableId: item.id,
      index: index
    }, (provided, snapshot) => /*#__PURE__*/react.createElement("div", App_extends({
      ref: provided.innerRef
    }, provided.draggableProps, provided.dragHandleProps), /*#__PURE__*/react.createElement("div", {
      className: "flex flex-row text-white px-2 py-1 my-2 text-sm cursor-pointer rounded ".concat(item.color, " custom-block mt-5 shadow ")
    }, /*#__PURE__*/react.createElement("div", {
      class: "puzzle-top"
    }), /*#__PURE__*/react.createElement("div", {
      className: "content flex flex-row p-2"
    }, /*#__PURE__*/react.createElement("p", {
      className: "flex-3"
    }, item.func), /*#__PURE__*/react.createElement("input", {
      type: item.inputType,
      className: "border-black text-black rounded mx-2 sideBaritem-input text-sm ",
      value: item.input,
      onChange: e => handleInputChange(columnId, item.id, e.target.value)
    })), /*#__PURE__*/react.createElement("div", {
      class: "puzzle-bottom"
